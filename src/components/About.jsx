...
export default function About() {
  return (
    <section
      id="about"
      className="min-h-screen px-4 sm:px-6 md:px-10 py-16 sm:py-20 bg-gradient-to-b from-[#0a0f1f] via-[#0d1b2a] to-[#1b263b] text-white flex flex-col justify-center"
    >
      <motion.h2
      ...
      <div className="max-w-5xl mx-auto text-center space-y-4 sm:space-y-6">
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="inline-block mt-4 sm:mt-6 bg-gradient-to-r from-pink-500 to-purple-600 px-6 sm:px-8 py-3 rounded-full text-white font-semibold shadow-lg hover:shadow-purple-500/40 transition"
        >
          View Resume
        </motion.a>
      </div>
